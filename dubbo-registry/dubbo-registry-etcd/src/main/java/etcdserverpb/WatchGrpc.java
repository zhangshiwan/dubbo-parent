...
public class WatchGrpc {
  ...
  public static final io.grpc.MethodDescriptor<Rpc.WatchRequest,
      Rpc.WatchResponse> METHOD_WATCH =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING,
          generateFullMethodName(
              "etcdserverpb.Watch", "Watch"),
          io.grpc.protobuf.ProtoUtils.marshaller(Rpc.WatchRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(Rpc.WatchResponse.getDefaultInstance()));
  ...
  public static interface Watch {
    ...
    public io.grpc.stub.StreamObserver<Rpc.WatchRequest> watch(
            io.grpc.stub.StreamObserver<Rpc.WatchResponse> responseObserver);
  }
